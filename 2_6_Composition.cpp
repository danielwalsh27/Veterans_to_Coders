...
int main(){
	//create 2 homes total
	House emptyHome;

	//create 4 objects
	Kitchen myK(25,17, "Amazon Mirco", true, true, true, true);
	Garage myG(30,30,true);
	LivingRoom myLR(20,28,true, "Samsung 130inch");
	MasterBed myMB(15,18, true, false);

	//make second home
	House myHousy(myK, myG, myLR, myMB);
	cout << "The total sqft is: " << myHousy.get_HouseSqFt() << endl;
